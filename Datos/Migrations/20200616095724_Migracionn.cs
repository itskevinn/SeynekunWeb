...
{
    public partial class Migracionn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CodigoControl = table.Column<string>(maxLength: 20, nullable: false),
                    TipoControl = table.Column<string>(maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Controles", x => x.CodigoControl);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdInsumo = table.Column<string>(maxLength: 30, nullable: false),
                    Ingrediente = table.Column<string>(maxLength: 40, nullable: true),
                    TipoIngrediente = table.Column<string>(maxLength: 40, nullable: true),
                    NumeroCas = table.Column<string>(maxLength: 30, nullable: true),
                    Observacion = table.Column<string>(maxLength: 200, nullable: true),
                    Ce = table.Column<decimal>(nullable: false),
                    Nop = table.Column<decimal>(nullable: false),
                    Jas = table.Column<decimal>(nullable: false),
                    Efapa = table.Column<decimal>(nullable: false),
                    Col = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdFabricante = table.Column<string>(maxLength: 40, nullable: true),
                    Nombre = table.Column<string>(maxLength: 35, nullable: false),
                    Uso = table.Column<string>(maxLength: 100, nullable: false),
                    RegistroIca = table.Column<string>(maxLength: 35, nullable: false),
                    Descripcion = table.Column<string>(maxLength: 200, nullable: true),
                    Resultado = table.Column<string>(maxLength: 100, nullable: true),
                    Estado = table.Column<string>(maxLength: 13, nullable: false),
